...
async function run() {
    ...
    const bundle = bundleVersion === "latest" ? await bundle_1.Bundle.getLatestBundle(token, repository) : await bundle_1.Bundle.getBundleByTag(token, repository, bundleVersion);
